...
- **Prototype-discovered refinements.** Exact interaction details that only become visible when the tree, treemap, progress, and selection model can be reacted to remain fog until prototyping. <clears-with: 04>
